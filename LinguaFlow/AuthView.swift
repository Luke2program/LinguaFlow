                ...
                VStack(spacing: 32) {
                    ...
                    HStack(spacing: 4) {
                        Text("By continuing, you agree to our")
                            .font(.caption2)
                            .foregroundStyle(.secondary)
                        Link("Privacy Policy", destination: URL(string: "https://lukaskoprolin.com/linguaflow-privacy.html")!)
                            .font(.caption2)
                        Text("and")
                            .font(.caption2)
                            .foregroundStyle(.secondary)
                        Link("EULA", destination: URL(string: "https://lukaskoprolin.com/linguaflow-eula.html")!)
                            .font(.caption2)
                    }
                    .padding(.top, 4)
                }
